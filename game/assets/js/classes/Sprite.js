...
class Sprite {
    constructor({ position, imageSrc, frameRate = 1, frameBuffer = 3, scale = 1 }) { // Embrulho os argumentos com {} em um objeto para facilitar a leitura e a manutenção do código.
